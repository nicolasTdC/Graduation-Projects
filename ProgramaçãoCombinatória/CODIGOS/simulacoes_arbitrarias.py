# -*- coding: utf-8 -*-
"""
Created on Fri May 26 16:11:58 2023
...
proporcoes_setor=[]
proporcoes_ativo=[]
vetor_0_a_1=np.arange(0.05, 1.01, 0.05)
...
for i in vetor_0_a_1:
    
    for j in vetor_0_a_1:

        proporcao_limite_por_ativo = [i for _ in range(frame.shape[0])]
    
        proporcao_limite_por_setor = [j for _ in range(len(sectors))]
